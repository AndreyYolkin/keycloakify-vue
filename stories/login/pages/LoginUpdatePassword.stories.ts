...
export const WithPasswordError: Story = {
  args: {
    kcContext: {
      ...
      messagesPerField: {
        existsError: (field: string, ...otherFields: string[]) => [field, ...otherFields].includes('password'),
...
export const WithPasswordConfirmError: Story = {
  args: {
    kcContext: {
      ...
      messagesPerField: {
        existsError: (field: string, ...otherFields: string[]) => [field, ...otherFields].includes('password-confirm'),
