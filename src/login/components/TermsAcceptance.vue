...
<template>
    <div class="form-group">
        <div :class="kcClsx('kcInputWrapperClass')">
            ...
            <div id="kc-registration-terms-text"><component :is="i18n.msg('termsText')" /></div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div v-if="messagesPerField.existsError('termsAccepted')" :class="kcClsx('kcLabelWrapperClass')">
            <span
