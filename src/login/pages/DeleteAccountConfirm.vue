...
<template>
    ...
    >
        ...
        <form :action="url.loginAction" class="form-vertical" method="post">
            <div class="alert alert-warning" style="margin-top: 0; margin-bottom: 30px">
            ...
            <p class="delete-account-text"><component :is="props.i18n.msg('finalDeletionConfirmation')" /></p>
