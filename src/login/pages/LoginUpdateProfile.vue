...
<template>
    ...
    >
        <template #header>
            <component :is="i18n.msg('loginProfileTitle')" />
        </template>

        <form id="kc-update-profile-form" :class="kcClsx('kcFormClass')" :action="url.loginAction" method="post">
            <component
            ...
            <div :class="kcClsx('kcFormGroupClass')">
                ...
                <div id="kc-form-buttons" :class="kcClsx('kcFormButtonsClass')">
                    <input
                        ...
                        :class="kcClsx('kcButtonClass', 'kcButtonPrimaryClass', !isAppInitiatedAction ? 'kcButtonBlockClass' : undefined, 'kcButtonLargeClass')"
                        type="submit"
