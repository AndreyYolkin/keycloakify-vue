...
<template>
    ...
    >
        <template #header>
            <component :is="i18n.msg('webauthn-login-title')" />
        </template>
                ...
                <template v-if="authenticators">
                    ...
                    <template v-if="shouldDisplayAuthenticators">
                        <p v-if="authenticators.authenticators.length > 1" :class="kcClsx('kcSelectAuthListItemTitle')">
                            <component :is="i18n.msg('webauthn-available-authenticators')" />
                        </p>
                            ...
                            >
                                ...
                                <div :class="kcClsx('kcSelectAuthListItemArrowIconClass')">
                                    ...
                                    >
                                        ...
                                        >
                                            <component :is="i18n.advancedMsg(displayNameProperty)" />
                                    ...
                                    <div :class="kcClsx('kcSelectAuthListItemDescriptionClass')">
                                        <span :id="`kc-webauthn-authenticator-createdlabel-${idx}`">
                                            <component :is="i18n.msg('webauthn-createdAt-label')" />
                                        </span>
