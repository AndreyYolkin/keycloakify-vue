...
<template>
    ...
    >
        ...
        <form id="kc-passwd-update-form" :class="kcClsx('kcFormClass')" :action="url.loginAction" method="post">
            ...
            <div :class="kcClsx('kcFormGroupClass')">
                ...
                <div id="kc-form-buttons" :class="kcClsx('kcFormButtonsClass')">
                    <input
                        :class="kcClsx('kcButtonClass', 'kcButtonPrimaryClass', !isAppInitiatedAction && 'kcButtonBlockClass', 'kcButtonLargeClass')"
                        type="submit"
