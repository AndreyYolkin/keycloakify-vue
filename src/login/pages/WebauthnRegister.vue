...
const props = defineProps<PageProps<Extract<KcContext, { pageId: "webauthn-register.ftl" }>, I18n>>();
...
<template>
    ...
    >
        <template #header>
            ...
            <component :is="i18n.msg('webauthn-registration-title')" />
        </template>

        <form id="register" :class="kcClsx('kcFormClass')" :action="url.loginAction" method="post">
