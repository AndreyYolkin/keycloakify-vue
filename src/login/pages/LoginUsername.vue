...
const props = defineProps<PageProps<Extract<KcContext, { pageId: "login-username.ftl" }>, I18n>>();
    ...
    >
        ...
        <template #socialProviders>
            ...
            >
                ...
                <ul :class="kcClsx('kcFormSocialAccountListClass', social.providers.length > 3 && 'kcFormSocialAccountListGridClass')">
                    <li v-for="p in social.providers" :key="p.providerId">
                        <a
                            :id="`social-${p.alias}`"
                            :class="kcClsx('kcFormSocialAccountListButtonClass', social.providers.length > 3 && 'kcFormSocialAccountGridItem')"
                            type="button"
                            :href="p.loginUrl"
                        >
                            <i v-if="p.iconClasses" :class="clsx(kcClsx('kcCommonLogoIdP'), p.iconClasses)" aria-hidden="true"></i>
                            <span
                    ...
                    <div :class="kcClsx('kcFormGroupClass', 'kcFormSettingClass')">
                        <div id="kc-form-options">
                            <div v-if="realm.rememberMe && !usernameHidden" class="checkbox">
                                <label>
                                    <input :tabindex="3" id="rememberMe" name="rememberMe" type="checkbox" :checked="!!login.rememberMe" />
