...
<template>
    ...
    >
        ...
        <form name="saml-post-binding" method="post" :action="samlPost.url" ref="formRef">
            <input v-if="samlPost.SAMLRequest" type="hidden" name="SAMLRequest" :value="samlPost.SAMLRequest" />
            <input v-if="samlPost.SAMLResponse" type="hidden" name="SAMLResponse" :value="samlPost.SAMLResponse" />
            <input v-if="samlPost.relayState" type="hidden" name="RelayState" :value="samlPost.relayState" />
            <noscript>
