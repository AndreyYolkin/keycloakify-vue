...
const props = defineProps<PageProps<Extract<KcContext, { pageId: "login-passkeys-conditional-authenticate.ftl" }>, I18n>>();
...
<template>
    ...
    >
        <template #header>
            <component :is="i18n.msg('passkey-login-title')" />
        </template>

        <template #info>
            <div v-if="realm.registrationAllowed && !registrationDisabled" id="kc-registration">
                <span>
        ...
        <div :class="kcClsx('kcFormGroupClass')" no-bottom-margin="true" :style="{ marginBottom: 0 }">
            <template v-if="authenticators !== undefined && Object.keys(authenticators).length !== 0">
                ...
                <template v-if="shouldDisplayAuthenticators">
                    <p v-if="authenticators.authenticators.length > 1" :class="kcClsx('kcSelectAuthListItemTitle')">
                        <component :is="i18n.msg('passkey-available-authenticators')" />
                    </p>
                    <div :class="kcClsx('kcFormClass')">
                        ...
                        >
                            ...
                            <div :class="kcClsx('kcSelectAuthListItemBodyClass')">
                                ...
                                >
                                    <component :is="i18n.advancedMsg(authenticator.label)" />
                                </div>
                                <div
                                    v-if="authenticator.transports !== undefined && authenticator.transports.displayNameProperties !== undefined && authenticator.transports.displayNameProperties.length !== 0"
                                ...
                                >
                                    <template
                                        ...
                                        :key="nameProperty"
                                    >
                                        <span> <component :is="i18n.advancedMsg(nameProperty)" /> </span>
                                ...
                                <div :class="kcClsx('kcSelectAuthListItemDescriptionClass')">
                                    <span :id="`kc-webauthn-authenticator-createdlabel-${idx}`">
                                        <component :is="i18n.msg('passkey-createdAt-label')" />
                                    </span>
            ...
            <div id="kc-form">
                <div id="kc-form-wrapper">
                    ...
                    >
                        <div v-if="!usernameHidden" :class="kcClsx('kcFormGroupClass')">
                            <label for="username" :class="kcClsx('kcLabelClass')">
                                <component :is="i18n.msg('passkey-autofill-select')" />
                            </label>
                            <input
                                :tabindex="1"
                                id="username"
                    ...
                    <div id="kc-form-passkey-button" :class="kcClsx('kcFormButtonsClass')" style="display: none">
                        <input
                            :id="authButtonId"
                            type="button"
                            autofocus
