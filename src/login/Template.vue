...
useSetClassName({
  qualifiedName: 'body',
  className: props.bodyClassName ?? kcClsx('kcBodyClass'),
});
  ...
  return h('div', { id: 'kc-username', class: kcClsx('kcFormGroupClass') }, [
    ...
    h(
      'a',
      {
        ...
        'aria-label': props.i18n.msgStr('restartLoginTooltip'),
      },
  ...
  >
    ...
    <div :class="kcClsx('kcFormCardClass')">
      <header :class="kcClsx('kcFormHeaderClass')">
        <div
          v-if="i18n.enabledLanguages.length > 1"
          ...
          >
            <div class="pf-c-alert__icon">
              <span
                ...
                :class="kcClsx('kcFeedbackSuccessIcon')"
              ></span>
              <span
              ...
              <span
                ...
                :class="kcClsx('kcFeedbackErrorIcon')"
              ></span>
              <span
                v-else-if="message.type === 'info'"
                :class="kcClsx('kcFeedbackInfoIcon')"
              ></span>
            </div>
            <span
              :class="kcClsx('kcAlertTitleClass')"
